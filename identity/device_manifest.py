...
class DeviceManifest:
    ...
    Example output:
        ...
        • AIDE Desk [mac_primary] — FULL NODE, PRIMARY RUNTIME
        ...
        Never infer the target. Never default to AIDE Desk unless explicitly requested.
    ...
    def build(self) -> str:
        ...
        lines.append(
            ...
            "3. Never default to AIDE Desk / Mac unless the user explicitly says so.\n"

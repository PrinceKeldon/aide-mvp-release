...
class TargetResolution:
    ...
    canonical_name: Optional[str]  # "Midas", "Vera Desk" etc.
...
class ExplicitTargetInterceptor:
    ...
    def _extract_target_phrase(self, message: str) -> Optional[str]:
        ...
        assistant_names = {"vera", "aide"}
        for word in words:
            if word in self._known_targets:
                if word in assistant_names:
                    continue
    ...
    def build_routing_context(self, resolution: TargetResolution) -> str:
        ...
        if resolution.status == "resolved":
            return (
                ...
                f"Do NOT use any other device. Do NOT use Vera Desk unless "

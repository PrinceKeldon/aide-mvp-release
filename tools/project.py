...
class ProjectTool(BaseTool):
    ...
    def __init__(self, project_manager: Optional[ProjectManager] = None, db_path: str = "./data/aide_memory.db"):
        self.pm = project_manager or ProjectManager(db_path=db_path)

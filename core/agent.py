...
SYSTEM_PROMPT = """You are AIDE, a personal AI agent running entirely on this device.
...
SEARCH_RESULT_PROMPT = """You are AIDE, a helpful personal agent.
...
Refined Query:"""
    ...
    async def _run_benchmark_research(self, user_message: str) -> str:
        ...
        prompt = (
            "You are AIDE doing a bounded benchmark research task. "
    ...
    async def run_terminal_chat(
        ...
        system = (
            f"You are AIDE running on AIDE Desk.\n"
